...
var ModalService = (function () {
    function ModalService() {
        this.currentProductModal = new Subject_1.Subject();
        this.modalShowing = new Subject_1.Subject();
        this.modalInit = new Subject_1.Subject();
    }
    ModalService.prototype.setCurrentModal = function (product) {
